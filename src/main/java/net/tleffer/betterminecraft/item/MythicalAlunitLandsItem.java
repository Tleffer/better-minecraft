...
public class MythicalAlunitLandsItem extends Item {
	public MythicalAlunitLandsItem() {
		super(new Item.Properties().tab(CreativeModeTab.TAB_TOOLS).durability(64));
		setRegistryName("mythical_alunit_lands");
	}
	...
	public InteractionResult useOn(UseOnContext context) {
		...
		if (!entity.mayUseItemAt(pos, context.getClickedFace(), itemstack)) {
			...
			if (world.isEmptyBlock(pos) && true) {
				MythicalAlunitLandsPortalBlock.portalSpawn(world, pos);
