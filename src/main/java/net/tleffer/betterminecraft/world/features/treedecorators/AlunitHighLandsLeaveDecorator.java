...
public class AlunitHighLandsLeaveDecorator extends LeaveVineDecorator {
	public static final AlunitHighLandsLeaveDecorator INSTANCE = new AlunitHighLandsLeaveDecorator();
	public static com.mojang.serialization.Codec<LeaveVineDecorator> codec;
	public static TreeDecoratorType<?> tdt;
	static {
		codec = com.mojang.serialization.Codec.unit(() -> INSTANCE);
		tdt = new TreeDecoratorType<>(codec);
		tdt.setRegistryName("alunit_high_lands_tree_leave_decorator");
