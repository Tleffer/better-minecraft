...
public class AlunitZombieBossGenerateProcedure {
	public static void execute(LevelAccessor world, double x, double y, double z) {
		world.setBlock(new BlockPos((int) x, (int) y, (int) z), BetterMinecraftModBlocks.ALUNIT_ZOMBIE_BOSS_BLOCK.defaultBlockState(), 3);
